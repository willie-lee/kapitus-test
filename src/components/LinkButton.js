...
const LinkButton = ({ href, children }) => {
    ...
    return (
        <a href={ href } className="btn btn-outline-success" target="_blank" rel="noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-link" viewBox="0 0 16 16" style={iconStyles}>
